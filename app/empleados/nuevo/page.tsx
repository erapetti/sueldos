  ...
  return (
    <div className="space-y-5">
      <EncabezadoPagina
        ...
        bajada="Se crean el empleado, el salario, el régimen horario, el valor hora sin aportes y el aporte a BPS, los cuatro últimos con vigencia desde el 1° del mes de ingreso."
      />
      <FormularioAlta />
    </div>
  )
