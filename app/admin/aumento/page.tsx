...
export default async function PaginaAumento() {
  ...
  return (
    <NoImplementado
      ...
      subtitulo="Alcanza a todo el personal activo del sistema, sea quien sea el dueño."
      motivo={`${AUMENTO_NO_IMPLEMENTADO} Falta definir qué parámetros entran: IPC, porcentaje por franja salarial, correctivo y tope. El resto del caso de uso ya está resuelto: al confirmarse, cada empleada incluida recibe en una sola transacción su nuevo salario y su nuevo valor hora sin aportes ajustado por el mismo porcentaje, ambos con la misma fecha de vigencia.`}
      volverA="/empleados"
      volverTexto="Volver a Mi Personal"
    />
  )
}
